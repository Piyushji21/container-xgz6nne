...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-xgz6nne.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-xgz6nne.containers.anotherwebservice.com/
...
```
git clone git@github.com:Piyushji21/container-xgz6nne.git
cd container-xgz6nne
```
...
```
docker attach container-xgz6nne
```
